...
<div class="page-container">
	<form action="${path}/productCategory/editCategory" method="post" class="form form-horizontal" id="form-user-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-6 col-sm-6">
				...
				<input type="text" class="input-text" value="${category.categoryName}" id="user-name" name="categoryName">
			</div>
		</div>
		<div class="row cl">
