...
<div class="page-container">
	<form action="${path}/ProductBrand/editBrand" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>品牌标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
                <input type="hidden" name="brandId" value="${brand.brandId}">
				<input type="text" class="input-text" value="${brand.brandName}" name="brandName">
			</div>
		</div>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button type="submit" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 提交</button>
			</div>
		</div>
	</form>
</div>
